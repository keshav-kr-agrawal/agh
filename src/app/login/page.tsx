...
function LoginContent() {
  ...
  return (
    <div className="w-full max-w-md bg-cream border border-cream-border rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
      ...
      {/* Interactive Tab Selector: Log In vs Sign Up */}
      ...
      <button
        ...
        onClick={async () => {
          setError('');
          setSuccess('Redirecting to Google Auth...');
        ...
        className="w-full py-3 px-4 bg-white border border-cream-border rounded-xl font-bold text-xs text-espresso hover:bg-cream-muted transition shadow-xs flex items-center justify-center gap-2"
      >
      ...
      <div className="relative flex items-center justify-center my-2">
        ...
        <span className="bg-cream px-3 text-[10px] font-bold text-espresso/50 uppercase tracking-wider whitespace-nowrap absolute">or continue with password</span>
      </div>
      ...
      <div className="pt-4 border-t border-cream-border text-center text-xs text-espresso/60 space-y-2">
        ...
        <div className="flex items-center justify-center gap-1 text-[11px] text-espresso/50">
          ...
          <span>Anita Gift House Official Authentication</span>
        </div>
      </div>
    </div>
  );
